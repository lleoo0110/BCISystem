            ...
            if ~isempty(data) && obj.params.gui.display.visualization.enable.spectrum
                if isfield(data, 'pxx') && isfield(data, 'f')
                    ...
                    if obj.params.gui.display.visualization.scale.auto
                        ...
                        % 周波数の表示範囲を50Hzまでに制限
                        xlim(obj.plotHandles.spectrum, [0 50]);
                    else
