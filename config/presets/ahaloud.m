function preset = ahaloud()
    %% === プリセット情報 ===
    preset_info = struct(...
        'name', 'ahaloud', ...
        'description', 'Ahaloud Experiment preset', ...
        'version', '2.0', ...
        'author', 'LLEOO', ...
        'date', '2025-01-26' ...
    );
    ...
    acquisition = struct(...
        ...
        'save', struct(...
            ...
            'name', 'ahaloud', ...      % 保存時のファイル名プレフィックス
            'path', './Experiment Data/Ahaloud', ... % データ保存先ディレクトリ
